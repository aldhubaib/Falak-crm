...
export function AccountClient({
  ...
  // In-app sound preference for THIS device (default on). Read after mount —
    ...
    <div className="mx-auto flex w-full max-w-lg flex-col gap-4 p-4 sm:p-6">
        ...
        <div className="mt-5 flex flex-col items-center gap-4">
          <div className="relative">
            {imageUrl ? (
              ...
              <div className="grid h-20 w-20 place-items-center rounded-full bg-teal-500/80 text-2xl font-semibold text-white">
                {initials}
              </div>
            )}
            <button
      ...
      <section className="flex items-center gap-3 rounded-2xl border border-border/60 bg-card p-4">
        ...
        <div className="min-w-0 flex-1">
          ...
          <div className="mt-0.5 text-xs text-muted-foreground">
            Play a sound when a notification arrives while the app is open.
          </div>
        </div>
        <Switch
          checked={soundOn}
