        ...
        <div className="w-full max-w-lg">
          <div className="rounded-xl border border-red-500/30 bg-[#1a1a1e] p-6">
            ...
            <div className="flex items-center gap-2">
              <button
                onClick={reset}
                className="h-10 px-4 rounded-full border border-gray-700 text-sm font-medium text-white hover:bg-white/5 transition-colors flex items-center gap-2"
              >
              ...
              <button
                onClick={handleCopy}
                className={`h-10 px-4 rounded-full border text-sm font-medium flex items-center gap-2 transition-all ${
                  copied
