...
export function TestRoleBanner() {
  ...
  return (
    <div className="flex items-center gap-3 px-4 py-2 bg-amber-500/10 border-b border-amber-500/20 shrink-0">
      ...
      <span className="text-[12px] text-amber-400 flex-1">
      ...
      <button
        ...
        disabled={stopping}
        className="flex items-center gap-1 text-[11px] font-medium text-amber-400 bg-amber-500/15 hover:bg-amber-500/25 px-2.5 py-1 rounded-lg transition-colors shrink-0"
      >
