                ...
                >
                  ...
                  <div className={cn("flex max-w-[70%] flex-col gap-1.5", mine && "items-end")}>
                    ...
                    {(m.body || replied || (m.task && !target.taskId)) && (() => {
                      // Task notices (linked-task messages, rejections) always use
                      // the dark card style from the Lovable design — even for the
                      // sender — so the reference card and banner read clearly.
                      const notice =
                      ...
                      <div className="group relative">
                        ...
                        >
                          ...
                          {m.body &&
                            (m.kind === "rejection" ? (
                              (() => {
                                // Rejection bodies are "@Name reason…" — pull the
                                // mention out so the reason sits inside the banner
                                // and the @chip renders on its own line, like the
                                // Lovable design.
