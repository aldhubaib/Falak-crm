  ...
  return (
    <div className="p-6">
      <div className="flex items-center gap-3 h-12 mb-6">
        ...
        <h1 className="text-heading font-semibold text-foreground">Pipelines & Stages</h1>
    ...
    <div className="rounded-xl border border-border bg-card p-4">
      <div className="flex items-center justify-between mb-4">
        <div className="flex items-center gap-2">
          <h3 className="text-subheading font-medium text-foreground">{pipeline.name}</h3>
          {pipeline.isDefault && (
            <span className="px-1.5 py-0.5 rounded text-label font-medium bg-primary/15 text-primary">Default</span>
          )}
        </div>
        <button
      ...
      <div className="space-y-1">
        {pipeline.stages.map((stage) => (
          ...
          >
            ...
            />
            <span className="flex-1 text-body text-foreground">{stage.name}</span>
            <span className={`px-1.5 py-0.5 rounded text-label font-medium ${
