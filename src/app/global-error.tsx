        ...
        <div className="w-full max-w-lg">
          <div className="rounded-xl border border-red-500/30 bg-[#1a1a1e] p-6">
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                <h2 className="text-subheading font-semibold">Application Error</h2>
            ...
            {appError && (
              <div className="mb-4">
                <button
                  ...
                  className="flex items-center gap-1.5 text-sub text-gray-400 hover:text-white transition-colors"
                >
                ...
                {expanded && (
                  <div className="mt-3 rounded-lg bg-black/30 border border-gray-800 p-4 max-h-[300px] overflow-auto">
                    <div className="space-y-1.5 text-sub font-mono text-gray-400">
                    ...
                    {appError.stack && (
                      <pre className="mt-3 text-label font-mono text-gray-500 whitespace-pre-wrap break-all leading-relaxed border-t border-gray-800 pt-3">
                        {appError.stack}
                      </pre>
                    )}
                  </div>
            ...
            <div className="flex items-center gap-2">
              <button
                onClick={reset}
                className="min-h-touch px-4 rounded-full border border-gray-700 text-button font-medium text-white hover:bg-white/5 transition-colors flex items-center gap-2"
              >
